#共通パーティクル＆サウンド
    ...
    playsound entity.player.attack.sweep player @a ~ ~ ~ 1 1.5 0
...
##属性分岐-計算＆攻撃
    #無属性
    execute as @s[scores={stat_player.Attribute=0}] at @s run function weapon:item/0_short_sword/assets/none
